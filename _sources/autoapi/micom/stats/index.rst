...
.. py:function:: correlate_fluxes(fluxes, metadata_column, groups=None, threads=1, progress=True)

   Compare fluxes form different sample groups.

   .. note:: This uses a non-parametric test by default (Spearman rank correlation).
